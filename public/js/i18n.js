    ...
    const DICT = {
        fr: {
            ...
            'home.hero.title_html':
                '<span class="hero-heading__line">L’application <span class="text-gradient-hero">Go Drive</span></span><span class="hero-heading__line">pour vos <span class="text-gradient-hero">livraisons</span></span>',
            'home.hero.lead':
                'Téléchargez l’application Go Drive pour publier une demande, choisir un livreur et suivre chaque étape — local, inter-ville ou à l’étranger. Le site sert uniquement à présenter l’app.',
            'home.hero.cta1': 'Télécharger gratuitement',
        ...
        en: {
            ...
            'home.hero.title_html':
                '<span class="hero-heading__line">The <span class="text-gradient-hero">Go Drive</span> app</span><span class="hero-heading__line">for your <span class="text-gradient-hero">deliveries</span></span>',
            'home.hero.lead':
                'Download the Go Drive app to post a request, choose a driver, and track every step — local, intercity, or abroad. This website only presents the app.',
            'home.hero.cta1': 'Download free',
        ...
        ar: {
            ...
            'home.hero.title_html':
                '<span class="hero-heading__line">تطبيق <span class="text-gradient-hero">Go Drive</span></span><span class="hero-heading__line">لـ <span class="text-gradient-hero">شحناتك</span></span>',
            'home.hero.lead':
                'حمّل تطبيق Go Drive لنشر طلب، اختيار سائق ومتابعة كل مرحلة — محليًا، بين المدن أو في الخارج. هذا الموقع لتقديم التطبيق فقط.',
            'home.hero.cta1': 'تحميل مجاني',
